...
using namespace std;
const int n_user = 1435;
const int n_item = 1522;
...
REGISTER_OP("TreeOut")
  ...
  .Output("u_gpu0_layer1_neighboor_seg: int32")
  ...
  .Output("u_gpu0_layer2_neighboor_seg: int32")
  ...
  .Output("u_gpu1_layer1_neighboor_seg: int32")
  ...
  .Output("u_gpu1_layer2_neighboor_seg: int32")
  ...
  .Output("u_gpu2_layer1_neighboor_seg: int32")
  ...
  .Output("u_gpu2_layer2_neighboor_seg: int32")
  ...
  .Output("u_gpu3_layer1_neighboor_seg: int32")
  ...
  .Output("u_gpu3_layer2_neighboor_seg: int32")
  ...
  .Output("p_gpu0_layer1_neighboor_seg: int32")
  ...
  .Output("p_gpu0_layer2_neighboor_seg: int32")
  ...
  .Output("p_gpu1_layer1_neighboor_seg: int32")
  ...
  .Output("p_gpu1_layer2_neighboor_seg: int32")
  ...
  .Output("p_gpu2_layer1_neighboor_seg: int32")
  ...
  .Output("p_gpu2_layer2_neighboor_seg: int32")
  ...
  .Output("p_gpu3_layer1_neighboor_seg: int32")
  ...
  .Output("p_gpu3_layer2_neighboor_seg: int32")
  ...
  .Output("n_gpu0_layer1_neighboor_seg: int32")
  ...
  .Output("n_gpu0_layer2_neighboor_seg: int32")
  ...
  .Output("n_gpu1_layer1_neighboor_seg: int32")
  ...
  .Output("n_gpu1_layer2_neighboor_seg: int32")
  ...
  .Output("n_gpu2_layer1_neighboor_seg: int32")
  ...
  .Output("n_gpu2_layer2_neighboor_seg: int32")
  ...
  .Output("n_gpu3_layer1_neighboor_seg: int32")
  ...
  .Output("n_gpu3_layer2_neighboor_seg: int32");
...
class TreeOutOp : public OpKernel {
 public:
  explicit TreeOutOp(OpKernelConstruction* context) : OpKernel(context) {
    ...
    // load_size
    load_size(neighboor_sizes, layer_num, "data_bin/neighboor_size.bin");
    load_size(indice_sizes, layer_num, "data_bin/indice_size.bin");

    // load neighboor, indices, values, dense_shape
    load_data_int(neighboors, neighboor_sizes, layer_num, "data_bin/neighboor.bin");
      ...
      for (int gpu = 0; gpu < 4; gpu++) {
        ...
        for (int layer = 0; layer < layer_num; layer++) {
          ...
          if (true) {
            ...
            output_seg= NULL;
            OP_REQUIRES_OK(context, context->allocate_output(
              format(root_mode, "neighboor_seg", gpu, layer+1), {count}, &output_seg));
            auto output_flat_neigh_seg = output_seg->flat<int32>();

            idx = 0;
            for (int i=0; i < N; i++) { // concatenate
              int* dat = neighboors[layer][input_ids(i)];
              for (int j=0; j<neighboor_sizes[layer][input_ids(i)]; j++) {
                output_flat_neigh(idx) = dat[j];
                output_flat_neigh_seg(idx) = i;
                idx++;
              }
            }
          }
          ...
          else{ // last adj need 3 cols
            OP_REQUIRES_OK(context, context->allocate_output(
              format(root_mode, "adj_indices", gpu, layer), {count, 3}, &output));
          }
          ...
          for (int i=0; i < N; i++) {
            ...
            for (int j=0; j < dat_size; j++) {
              ...
              if (false){//layer == layer_num - 1){
                output_flat_ind(idx) = i; idx++;
              }
 ...
 private:
  int *neighboor_sizes[layer_num];
  int **neighboors[layer_num];
